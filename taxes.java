...
public class taxes {
    ...
    public void calcBudget(double THP) {
        ...
        System.out.format("%nWhat percentage of the Take Home Pay should be allocated towards the category: Needs (food, shelter, etc.) (%%)?: ");
        ...
        System.out.print("What percentage of the Take Home Pay should be allocated towards the category: Savings (emergency fund, education fund, etc.) (%)?: ");
        taxes.checkMonthlyIncome();
        ...
        taxes.percentUpdate(total);
        System.out.print("What percentage of the Take Home Pay should be allocated towards the category: Investments (retirement, stocks, etc.) (%)?: ");
        taxes.checkMonthlyIncome();
        ...
        taxes.percentUpdate(total);
        System.out.format("What percentage of the Take Home Pay should be allocated towards the category: Wants (hobbies, fun stuff) (%%)?: %f%n", total);
